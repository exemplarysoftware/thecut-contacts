...
class ContactRelatedInlineForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.instance.pk:
            ...
            related_data = forms.models.model_to_dict(related_instance,
...
class ContactAddressInlineForm(ContactRelatedInlineForm):
    ...
    country = forms.ChoiceField(label='Country', choices=COUNTRIES,
        initial=settings.DEFAULT_COUNTRY, required=False)
    
    _related_fields = ['name', 'street', 'city', 'state', 'postcode', 'country']
