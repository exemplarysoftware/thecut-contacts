...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ContactAddress', fields ['contact', 'address']
        db.create_unique('contacts_contactaddress', ['contact_id', 'address_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ContactAddress', fields ['contact', 'address']
        db.delete_unique('contacts_contactaddress', ['contact_id', 'address_id'])
