...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_index('contacts_organisation', ['name'])

        # Adding index on 'Organisation', fields ['abn']
        db.create_index('contacts_organisation', ['abn'])


    def backwards(self, orm):
        
        # Removing index on 'Organisation', fields ['abn']
        db.delete_index('contacts_organisation', ['abn'])

        # Removing index on 'Organisation', fields ['name']
        db.delete_index('contacts_organisation', ['name'])
