...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('contacts_contactemail', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('contact', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'emails_new', to=orm['contacts.Contact'])),
            ('email', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'contacts_new', to=orm['contacts.Email'])),
            ('order', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal('contacts', ['ContactEmail'])

        # Adding unique constraint on 'ContactEmail', fields ['contact', 'email']
        db.create_unique('contacts_contactemail', ['contact_id', 'email_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ContactEmail', fields ['contact', 'email']
        db.delete_unique('contacts_contactemail', ['contact_id', 'email_id'])

        # Deleting model 'ContactEmail'
        db.delete_table('contacts_contactemail')
    ...
    models = {
        ...
        'contacts.contactemail': {
            ...
            'contact': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'emails_new'", 'to': "orm['contacts.Contact']"}),
            'email': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'contacts_new'", 'to': "orm['contacts.Email']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'})
        },
