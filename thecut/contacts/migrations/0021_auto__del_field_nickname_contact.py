...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Nickname.contact'
        db.delete_column('contacts_nickname', 'contact_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Nickname.contact'
        raise RuntimeError("Cannot reverse this migration. 'Nickname.contact' and its values cannot be restored.")
