...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Email.contact'
        raise RuntimeError("Cannot reverse this migration. 'Email.contact' and its values cannot be restored.")
