...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('contacts_contactphone', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('contact', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'phones_new', to=orm['contacts.Contact'])),
            ('phone', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'contacts', to=orm['contacts.Phone'])),
            ('order', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal('contacts', ['ContactPhone'])

        # Adding unique constraint on 'ContactPhone', fields ['contact', 'phone']
        db.create_unique('contacts_contactphone', ['contact_id', 'phone_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ContactPhone', fields ['contact', 'phone']
        db.delete_unique('contacts_contactphone', ['contact_id', 'phone_id'])

        # Deleting model 'ContactPhone'
        db.delete_table('contacts_contactphone')
    ...
    models = {
        ...
        'contacts.contactphone': {
            ...
            'contact': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'phones_new'", 'to': "orm['contacts.Contact']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
