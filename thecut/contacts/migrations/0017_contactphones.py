...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """Create ContactPhone objects."""
        for index, phone in enumerate(orm['contacts.Phone'].objects.all()):
            orm['contacts.ContactPhone'](contact=phone.contact,
                phone=phone, order=index+1).save()

    def backwards(self, orm):
        """Remove ContactPhone objects."""
        for contact_phone in orm['contacts.ContactPhone'].objects.all():
