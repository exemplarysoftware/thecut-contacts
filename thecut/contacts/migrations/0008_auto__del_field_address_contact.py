...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Address.contact'
        db.delete_column('contacts_address', 'contact_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Address.contact'
        raise RuntimeError("Cannot reverse this migration. 'Address.contact' and its values cannot be restored.")
