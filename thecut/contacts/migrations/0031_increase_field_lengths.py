...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'contacts_website', 'name', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'ContactGroup.name'
        db.alter_column(u'contacts_contactgroup', 'name', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'Address.city'
        db.alter_column(u'contacts_address', 'city', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'Address.name'
        db.alter_column(u'contacts_address', 'name', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'Address.state'
        db.alter_column(u'contacts_address', 'state', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'Address.postcode'
        db.alter_column(u'contacts_address', 'postcode', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'PersonOrganisation.title'
        db.alter_column(u'contacts_personorganisation', 'title', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'PersonOrganisation.department'
        db.alter_column(u'contacts_personorganisation', 'department', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'Email.value'
        db.alter_column(u'contacts_email', 'value', self.gf('django.db.models.fields.EmailField')(max_length=254))

        # Changing field 'Email.name'
        db.alter_column(u'contacts_email', 'name', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'Person.title'
        db.alter_column(u'contacts_person', 'title', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'Organisation.name'
        db.alter_column(u'contacts_organisation', 'name', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'Nickname.value'
        db.alter_column(u'contacts_nickname', 'value', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'InstantMessengerHandle.value'
        db.alter_column(u'contacts_instantmessengerhandle', 'value', self.gf('django.db.models.fields.CharField')(max_length=254))

        # Changing field 'InstantMessengerHandle.name'
        db.alter_column(u'contacts_instantmessengerhandle', 'name', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'Phone.value'
        db.alter_column(u'contacts_phone', 'value', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'Phone.name'
        db.alter_column(u'contacts_phone', 'name', self.gf('django.db.models.fields.CharField')(max_length=250))

    def backwards(self, orm):

        # Changing field 'Website.name'
        db.alter_column(u'contacts_website', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'ContactGroup.name'
        db.alter_column(u'contacts_contactgroup', 'name', self.gf('django.db.models.fields.CharField')(max_length=150))

        # Changing field 'Address.city'
        db.alter_column(u'contacts_address', 'city', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Address.name'
        db.alter_column(u'contacts_address', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Address.state'
        db.alter_column(u'contacts_address', 'state', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Address.postcode'
        db.alter_column(u'contacts_address', 'postcode', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'PersonOrganisation.title'
        db.alter_column(u'contacts_personorganisation', 'title', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'PersonOrganisation.department'
        db.alter_column(u'contacts_personorganisation', 'department', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Email.value'
        db.alter_column(u'contacts_email', 'value', self.gf('django.db.models.fields.EmailField')(max_length=75))

        # Changing field 'Email.name'
        db.alter_column(u'contacts_email', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Person.title'
        db.alter_column(u'contacts_person', 'title', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'Organisation.name'
        db.alter_column(u'contacts_organisation', 'name', self.gf('django.db.models.fields.CharField')(max_length=150))

        # Changing field 'Nickname.value'
        db.alter_column(u'contacts_nickname', 'value', self.gf('django.db.models.fields.CharField')(max_length=75))

        # Changing field 'InstantMessengerHandle.value'
        db.alter_column(u'contacts_instantmessengerhandle', 'value', self.gf('django.db.models.fields.CharField')(max_length=75))

        # Changing field 'InstantMessengerHandle.name'
        db.alter_column(u'contacts_instantmessengerhandle', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Phone.value'
        db.alter_column(u'contacts_phone', 'value', self.gf('django.db.models.fields.CharField')(max_length=75))

        # Changing field 'Phone.name'
        db.alter_column(u'contacts_phone', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))
