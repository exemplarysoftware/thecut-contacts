...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ContactInstantMessengerHandle'
        db.create_table('contacts_contactinstantmessengerhandle', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('contact', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'instant_messenger_handles_new', to=orm['contacts.Contact'])),
            ('instant_messenger_handle', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'contacts', to=orm['contacts.InstantMessengerHandle'])),
            ('order', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal('contacts', ['ContactInstantMessengerHandle'])

        # Adding unique constraint on 'ContactInstantMessengerHandle', fields ['contact', 'instant_messenger_handle']
        db.create_unique('contacts_contactinstantmessengerhandle', ['contact_id', 'instant_messenger_handle_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ContactInstantMessengerHandle', fields ['contact', 'instant_messenger_handle']
        db.delete_unique('contacts_contactinstantmessengerhandle', ['contact_id', 'instant_messenger_handle_id'])

        # Deleting model 'ContactInstantMessengerHandle'
        db.delete_table('contacts_contactinstantmessengerhandle')
