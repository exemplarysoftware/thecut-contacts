...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'contacts_person', 'short_name',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'Person.long_name'
        db.add_column(u'contacts_person', 'long_name',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=250, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'contacts_person', 'short_name')

        # Deleting field 'Person.long_name'
        db.delete_column(u'contacts_person', 'long_name')
