...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ContactNickname'
        db.create_table('contacts_contactnickname', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('contact', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'nicknames_new', to=orm['contacts.Contact'])),
            ('nickname', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'contacts', to=orm['contacts.Nickname'])),
            ('order', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal('contacts', ['ContactNickname'])

        # Adding unique constraint on 'ContactNickname', fields ['contact', 'nickname']
        db.create_unique('contacts_contactnickname', ['contact_id', 'nickname_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ContactNickname', fields ['contact', 'nickname']
        db.delete_unique('contacts_contactnickname', ['contact_id', 'nickname_id'])

        # Deleting model 'ContactNickname'
        db.delete_table('contacts_contactnickname')
