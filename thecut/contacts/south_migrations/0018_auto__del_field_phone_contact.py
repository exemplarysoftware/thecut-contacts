...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('contacts_phone', 'contact_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Phone.contact'
        raise RuntimeError("Cannot reverse this migration. 'Phone.contact' and its values cannot be restored.")
